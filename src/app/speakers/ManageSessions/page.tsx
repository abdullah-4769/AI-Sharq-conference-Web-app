...
export default function      () {
  ...
  {/* Header */}
       <div className="box-border flex flex-col items-start p-6 gap-6 w-full max-w-7xl h-24 bg-[#FFEEEE] border border-[#D4D4D4] shadow-sm rounded-3xl mb-6">
                <div className="flex flex-col items-start p-0 gap-4 w-full h-12">
                  <div className="flex flex-row items-center p-0 gap-4 w-full h-12">
                    <div className="flex flex-col items-start p-0 gap-3 w-full h-12">
                      <div className="flex flex-row items-center p-0 gap-3 w-full h-12">
