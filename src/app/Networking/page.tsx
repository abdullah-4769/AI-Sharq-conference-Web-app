  ...
  <FaArrowRight className="text-[#9B2033] text-2xl ml-auto" />
    ...
    <FaArrowLeft className="text-red-800 w-[20px] h-[20px] cursor-pointer" />
       ...
       <div className="flex flex-row items-center p-0 gap-4 w-[1280px] h-11">
          ...
          <Link href="/MyConnections">
          <button className="box-border flex flex-col justify-center items-center p-4 gap-3 w-80 h-11 border border-[#E8E8E8] rounded-xl">
            <span className="text-bold font-medium text-[#282828]">My Connections</span>
          </button>
          </Link>
                ...
                <div className="flex flex-col justify-center items-start p-0 gap-6 w-[1087px] h-20">
                  <div className="flex flex-row items-center p-0 gap-3 w-[1087px] h-8">
                    ...
                    <button
                      ...
                      className={`flex flex-row absolute left-[1150px] p-3 gap-3 rounded-full text-md font-bold ${
                        user.isConnected
                          ? 'bg-[#F7FCDC] text-[#849122]'
                          : 'bg-[#FCDCDC] text-[#9B2033]'
                      }`}
                    >
