    ...
    <div className="flex flex-col gap-10 p-5 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col gap-6">
        {filteredSpeakers.map((speaker, index) => (
          <div key={index} className="bg-white border border-gray-300 rounded-2xl p-6 shadow-sm">
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="w-1 h-1 bg-red-700 rounded-full"></div>
                  <p className="text-base text-gray-900 flex-1">{speaker.organization}</p>
